...
export function CareMedicineAccess({ hindi, entry = EMPTY_MEDICINE_ACCESS_ENTRY, onChange, careTeam }: {
  ...
  return <main className="care-medicine-access">
    ...
    <section className="cma-search" aria-labelledby="cma-location-title">
      ...
      <div className="cma-directory-links"><a href={mapUrl}>{t('Open nearby palliative care map', 'पास के पैलिएटिव देखभाल केंद्र देखें')} ↗</a><a href="https://www.palliativecare.in/palliative-care-directory-of-india/" target="_blank" rel="noopener noreferrer">{t('Indian Association of Palliative Care directory', 'इंडियन एसोसिएशन ऑफ़ पैलिएटिव केयर सूची')} ↗</a></div>
